...
class ManagerRevirewController extends Controller
{
    public function showManagwerReview($emp_id){
        ...
        $managerColumnMapings = [
            ...
            'demonstrated' => '4. Can you provide an example of when the employee demonstrated problem-solving skills?',
            'comments_demonstrated' => 'Justify Review',
            'leadership_responsibilities' => '5. Has the employee shown leadership potential or accepted additional responsibilities?',
