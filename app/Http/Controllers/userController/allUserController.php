...
class allUserController extends Controller
{
    ...
    public function searchUser(Request $request)
    {
        ...
        $currentUserId = session('user_id'); // Make sure this is stored during login
        ...
        */
        ...
        switch ($currentUserType) {
            ...
            case 'manager':
                // Manager can search only employees assigned to this Manager
                $query->where('manager_id', $currentUserId);
                break;

            case 'superadmin':
            case 'super_admin':
                // Super Admin can search everyone
                break;
    ...
    public function adminReviewStore(Request $request)
    {
        ...
        $request->validate([
            ...
            'comments_demonstrated_attendance' => 'max:1500',
            'employee_manage_shift' => 'required|numeric',
            'comments_employee_manage_shift' => 'max:1500',
            'documentation_neatness' => 'required|numeric',
            'comments_documentation_neatness' => 'max:1500',
            'followed_instructions' => 'required|numeric',
            'comments_followed_instructions' => 'max:1500',
            'productive' => 'required|numeric',
            'comments_productive' => 'max:1500',
            'changes_schedules' => 'required|numeric',
            'comments_changes_schedules' => 'max:1500',
            'leave_policy' => 'required|numeric',
            'comments_leave_policy' => 'max:1500',
            'salary_deduction' => 'required|numeric',
            'comments_salary_deduction' => 'max:1500',
            'interact_housekeeping' => 'required|numeric',
            'comments_interact_housekeeping' => 'max:1500',
    ...
    public function hrReviewStore(Request $request)
    {
        ...
        $request->validate([
            ...
            'comments_adherence_hr' => 'max:1500',
            'professionalism_positive' => 'required|numeric',
            'comments_professionalism' => 'max:1500',
            'respond_feedback' => 'required|numeric',
            'comments_respond_feedback' => 'max:1500',
            'initiative' => 'required|numeric',
            'comments_initiative' => 'max:1500',
            'interest_learning' => 'required|numeric',
            'comments_interest_learning' => 'max:1500',
            'company_leave_policy' => 'required|numeric',
            'comments_company_leave_policy' => 'max:1500',
    ...
    public function managerReviewStore(Request $request)
    {
        ...
        $request->validate([
            ...
            'comments_rate_employee_quality' => 'required|string|max:1500',
            'organizational_goals' => 'required|numeric',
            'comments_organizational_goals' => 'required|string|max:1500',
            'collaborate_colleagues' => 'required|numeric',
            'comments_collaborate_colleagues' => 'required|string|max:1500',
            'demonstrated' => 'required|numeric',
            'comments_demonstrated' => 'required|string|max:1500',
            'leadership_responsibilities' => 'required|numeric',
            'comments_leadership_responsibilities' => 'required|string|max:1500',
            'thinking_contribution' => 'required|numeric',
            'comments_thinking_contribution' => 'required|string|max:1500',
            'informed_progress' => 'required|numeric',
            'comments_comments_informed_progress' => 'required|string|max:1500',
    ...
    public function clientReviewStore(Request $request)
    {
        ...
        try {
            ...
            $validatedData = $request->validate([
                ...
                // Comment fields
                'comment_understand_requirements' => 'required|string|max:1500',
                'comments_business_needs' => 'required|string|max:1500',
                'comments_detailed_project_scope' => 'required|string|max:1500',
                'comments_responsive_reach_project' => 'required|string|max:1500',
                'comments_comfortable_discussing' => 'required|string|max:1500',
                'comments_regular_updates' => 'required|string|max:1500',
                'comments_concerns_addressed' => 'required|string|max:1500',
                'comments_technical_expertise' => 'required|string|max:1500',
                'comments_best_practices' => 'required|string|max:1500',
                'comments_suggest_innovative' => 'required|string|max:1500',
                'comments_quality_code' => 'required|string|max:1500',
                'comments_encounter_issues' => 'required|string|max:1500',
                'comments_code_scalable' => 'required|string|max:1500',
                'comments_solution_perform' => 'required|string|max:1500',
                'comments_project_delivered' => 'required|string|max:1500',
                'comments_communicated_handled' => 'required|string|max:1500',
                'comments_development_process' => 'required|string|max:1500',
                'comments_unexpected_challenges' => 'required|string|max:1500',
                'comments_effective_workarounds' => 'required|string|max:1500',
                'comments_bugs_issues' => 'required|string|max:1500',
            ], [
