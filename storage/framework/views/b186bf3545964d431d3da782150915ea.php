...
<?php $__env->startSection('title', 'Appraisal Done'); ?>

<?php $__env->startSection('breadcrumb', 'Appraisal Done'); ?>
        ...
        <div class="table-wrapper">
            ...
            <table class="table table-bordered table-hover main-table table-view financial-table" id="employeeDetails"
                ...
                <tbody id="employeeList">
                    <?php $__currentLoopData = $financialData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $financial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    
                    <tr>
                        <td><?php echo e($financial->emp_id); ?></td>
                        
                        <td><?php echo e($financial->employee_name ?? '-'); ?></td>
                        <td><?php echo e($financial->evaluation_score ?? '-'); ?></td>
                        <td><?php echo e($financial->hr_review ?? '-'); ?></td>
                        <td><?php echo e($financial->admin_review ?? '-'); ?></td>
                        <td><?php echo e($financial->manager_review ?? '-'); ?></td>
                        <td><?php echo e($financial->clint_review ?? '-'); ?></td>
                        <td><?php echo e($financial->apprisal_score ?? '-'); ?></td>
                        <td><?php echo e($financial->current_salary ?? '-'); ?></td>
                        <td><?php echo e($financial->percentage_given ?? '-'); ?></td>
                        <td><?php echo e($financial->financial_year ?? '-'); ?></td>
                        <td><?php echo e($financial->update_salary ?? '-'); ?></td>
                        <td><?php echo e($financial->final_salary ?? '-'); ?></td>
                        <td><?php echo e($financial->apprisal_date ?? '-'); ?></td>
                    </tr>
...
<script>
    ...
    function searchEmployee() {
        ...
        if (query === "") {
            ...
            $.ajax({
                url: "<?php echo e(route('super.user.search.bar')); ?>", // Your backend route
                type: 'GET',
        ...
        $.ajax({
            url: "<?php echo e(route('super.user.search.bar')); ?>",
            type: 'GET',
            data: { query: query },
            dataType: 'json',
            headers: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/relaxed-tereshkova.74-208-156-247.plesk.page/modest-gagarin.74-208-156-247.plesk.page/resources/views/admin/FinancialTable.blade.php ENDPATH**/ ?>