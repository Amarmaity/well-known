...
<?php $__env->startSection('breadcrumb', 'Client Management'); ?>
<?php $__env->startSection('page-title', 'Client Management'); ?>
...
<?php $__env->startSection('content'); ?>
                ...
                <table id="userTable" class="table  table-bordered table-hover table-view user-list-table modified-table"
                    ...
                    <tbody>
                        <?php $__currentLoopData = $allClients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr data-status="<?php echo e($client->status ? '1' : '2'); ?>">
                                <td><?php echo e($client->client_name); ?></td>
                                <td><?php echo e($client->company_name ?? '-'); ?></td>
                                <td><?php echo e($client->client_mobno); ?></td>
                                <td><?php echo e($client->client_email); ?></td>
                                <td class="status-class" id="status-<?php echo e($client->id); ?>">
                                ...
                                <td>
                                    <input type="checkbox" class="toggle-btn" data-toggle="toggle" data-size="mini"
                                        ...
                                        data-user-type="client" data-identifier="<?php echo e($client->id); ?>" <?php echo e($client->status ? 'checked' : ''); ?>>
                                </td>
                            </tr>
    ...
    <script>
        function getToggleStatusUrl(user_type, id) {
            ...
            if (user_type === "client") {
                return "<?php echo e(url('/toggle-status-client')); ?>/" + id; // <-- this must match your Laravel route
            }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/relaxed-tereshkova.74-208-156-247.plesk.page/modest-gagarin.74-208-156-247.plesk.page/resources/views/admin/clientManagement.blade.php ENDPATH**/ ?>