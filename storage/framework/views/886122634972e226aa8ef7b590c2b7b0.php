<?php $__env->startSection('title', 'Hr Review Dashboard'); ?>
<?php $__env->startSection('breadcrumb', 'Hr Review List'); ?>
<?php $__env->startSection('page-title', 'Hr-Review-Section'); ?>
                        ...
                        <?php $__currentLoopData = $superAddUser; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <select id="financialYear" class="form-control financial-year input-block" required>
                                    ...
                                    <div class="btn-block">
                                        <?php
                                            ...
                                            if (
                                                !($sessionUserType === 'hr' && $sessionEmployeeId == $user->employee_id)
                                            ) {
                                                echo ' <a href="' .
                                                    route('user-hr-details', $user->employee_id) .
                                                    '"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/well-known/resources/views/reports/hrReportView.blade.php ENDPATH**/ ?>