                    ...
                    <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="span-data">1. How would you rate the employee’s quality of work, including accuracy,
                                neatness, and
                                timeliness? <span>(<?php echo e($review->rate_employee_quality); ?>/5)</span>
                            </td>
                        ...
                        <tr>
                            <td class="span-data">2. Does the employee align their work with the organization's goals and
                                objectives? <span>(<?php echo e($review->organizational_goals); ?> /5)</span></td>
                        ...
                        <tr>
                            <td class="span-data">3. How effectively does the employee contribute to team efforts and
                                collaborate with colleagues? <span>(<?php echo e($review->collaborate_colleagues); ?> /5)</span>
                            </td>
                        ...
                        <tr>
                            <td class="span-data">4. Has the employee shown leadership potential or accepted additional
                                responsibilities? <span>(<?php echo e($review->leadership_responsibilities); ?>/5)</span></td>
                            <td>
                                <?php echo e($review->comments_leadership_responsibilities); ?>

                            </td>
                        </tr>
                        <tr>
                            <td class="span-data">5. Can you provide an example of when the employee demonstrated
                                problem-solving skills? <span>(<?php echo e($review->demonstrated); ?> /5)</span></td>
                        ...
                        <tr>
                            <td class="span-data">6. How would you rate the employee’s innovative thinking and contribution to
                                team success? <span>(<?php echo e($review->demonstrated); ?> /5)</span></td>
                        ...
                        <tr>
                            <td class="span-data">7. Does the employee effectively keep you informed about work progress and
                                issues? <span>(<?php echo e($review->informed_progress); ?> /5)</span></td>
                            <td><br> <?php echo e($review->comments_comments_informed_progress); ?></td>
                        </tr>
                        <tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/relaxed-tereshkova.74-208-156-247.plesk.page/modest-gagarin.74-208-156-247.plesk.page/resources/views/reports/userDetailsManagerView.blade.php ENDPATH**/ ?>