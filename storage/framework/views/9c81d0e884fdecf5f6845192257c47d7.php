                ...
                <table id="employeeEvaluationTable" class="table table-bordered table-hover main-table">
                    ...
                    <?php $__currentLoopData = $eval; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $evaluation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>(<?php echo e($evaluation->accuracy_neatness); ?> /5)</td>
                        ...
                        <tr>
                            ...
                            <td>(<?php echo e($evaluation->punctuality); ?> /5)</td>
                            <td><?php echo e($evaluation->comments_punctuality); ?></td>
                        </tr>
                        <tr>
                            <td>2. Attendance</td>
                            <td>(<?php echo e($evaluation->attendance); ?> /5)</td>
                        ...
                        <tr>
                            ...
                            <td>(<?php echo e($evaluation->initiatives_at_workplace); ?> /5)</td>
                            <td><?php echo e($evaluation->comments_initiatives); ?></td>
                        </tr>
                        <tr>
                            <td>4. Submits reports on time and meets deadlines</td>
                            <td>(<?php echo e($evaluation->submits_reports); ?> /5)</td>
                        ...
                        <tr>
                            ...
                            <td>(<?php echo e($evaluation->respond_contributes); ?>/5)</td>
                        ...
                        <tr>
                            ...
                            <td>(<?php echo e($evaluation->challenges); ?>/10)</td>
                        ...
                        <tr>
                            ...
                            <td>(<?php echo e($evaluation->personal_growth); ?>/10)</td>
                            <td><?php echo e($evaluation->comments_personal_growth); ?></td>
                        </tr>
                        <tr>
                            <td>3. Work motivation</td>
                            <td>(<?php echo e($evaluation->work_motivation); ?> /5)</td>
                        ...
                        <tr>
                            ...
                            <td>(<?php echo e($evaluation->progress_unsatisfactory); ?>)</td>
                        ...
                        <tr>
                            ...
                            <td>(<?php echo e($evaluation->progress_acceptable); ?>)</td>
                        ...
                        <tr>
                            ...
                            <td>(<?php echo e($evaluation->progress_outstanding); ?>)</td>
...
<?php $__env->stopSection(); ?>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/delose1a/evalon.delostylestudio.co.in/resources/views/reports/userEvaluationDetails.blade.php ENDPATH**/ ?>