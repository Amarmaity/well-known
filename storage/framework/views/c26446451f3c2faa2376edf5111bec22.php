            ...
            <div class="client">
                ...
                <select id="financialYear" class="form-select client__select" name="financial_year" required>
                    ...
                    <?php $__currentLoopData = $years; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <option value="<?php echo e($fy); ?>" <?php echo e((isset($financial_year) && $financial_year == $fy)
                        ? 'selected'
                        : (!isset($financial_year) && $year == $currentFYStart ? 'selected' : '')); ?>>
                                    <?php echo e($fy); ?>
                        ...
                        <div class="row form-div">
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <input type="text" name="review_period" id="review_period" placeholder="Enter Review Period"
                                    value="<?php echo e($financial_year ?? ''); ?>" class="form-control" readonly>
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="<?php echo e(asset('js/evaluationFrom.js')); ?>"></script>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\well-known\resources\views/evaluationForm/evaluationForm.blade.php ENDPATH**/ ?>