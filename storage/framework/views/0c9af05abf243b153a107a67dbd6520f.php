                    ...
                    <div class="row form-section">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="mobno" id="mobno" class="form-control"
                                value="<?php echo e($user->mobno); ?>" maxlength="10" min="0" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control" id="dob" name="dob"
                                value="<?php echo e($user->dob); ?>" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-control" id="designation_dropdown" name="designation" required>
                                ...
                                <option value="Quality Analyst"
                                    <?php echo e($user->designation == 'Quality Analyst' ? 'selected' : ''); ?>>Quality Analyst
                                </option>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-control" id="division_dropdown" name="division" required>
                                <option value="" disabled <?php echo e($user->division == null ? 'selected' : ''); ?>>Select
                                    Division
                                </option>
                                <option value="Kasba Office" <?php echo e($user->division == 'Kasba Office' ? 'selected' : ''); ?>>
                                    Kasba
                                    Office</option>
                        ...
                        <div class="client-hide col-md-6 search-wrap" id="manager-name-field">
                            ...
                            <input type="hidden" name="manager_name" id="manager_name"
                                value="<?php echo e($user->manager_name); ?>">
                        </div>


                        <div class="client-hide col-md-6 search-wrap" id="admin-name-field">
                            <label for="admin_id" class="forms-label">Admin</label>

                            <select class="form-control select2-admin" id="admin_id" name="admin_id">
                                <?php if($user->admin): ?>
                                    <option value="<?php echo e($user->admin_id); ?>" selected>
                                        <?php echo e($user->admin->fname); ?> <?php echo e($user->admin->lname); ?>
                        ...
                        <div class="client-hide col-md-6 search-wrap" id="hr-name-field">
                            <label for="hr_id" class="forms-label">HR</label>

                            <select class="form-control select2-hr" id="hr_id" name="hr_id">
                                <?php if($user->hr): ?>
                                    <option value="<?php echo e($user->hr_id); ?>" selected>
                                        <?php echo e($user->hr->fname); ?> <?php echo e($user->hr->lname); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-control" id="user_type_dropdown" name="user_type" required>
                                <option value="" disabled <?php echo e($user->user_type == null ? 'selected' : ''); ?>>Select
                                    User Type
                                </option>
                        ...
                        <div class="client-hide col-md-6">
                            ...
                            <input type="number" class="form-control" id="salary" name="salary"
                                placeholder="Enter Salary" min="0" value="<?php echo e($user->salary); ?>" required>
                        </div>
                                ...
                                <?php if(!in_array($role, $hiddenRoles)): ?>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input check-input" type="checkbox" name="user_roles[]"
                                            ...
                                            id="<?php echo e($role === 'client' ? 'client-role' : $role); ?>"
                                            <?php echo e(in_array($role, $userRoles) ? 'checked' : ''); ?>>
                                        <label class="form-check-label"
                                            for="<?php echo e($role === 'client' ? 'client-role' : $role); ?>">
