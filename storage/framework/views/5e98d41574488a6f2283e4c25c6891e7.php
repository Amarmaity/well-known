...
<?php $__env->startSection('breadcrumb', 'User Listing'); ?>
<?php $__env->startSection('page-title', 'Apprisal-Section'); ?>
                ...
                <table id="userTable" class="table  table-bordered table-hover table-view user-list-table modified-table"
                    ...
                    <tbody>
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr data-status="<?php echo e($user->status ? '1' : '2'); ?>">
                                ...
                                <td><?php echo e($user->mobno); ?></td>
                                <td><?php echo e($user->email); ?></td>
                                <td class="status-class" id="status-<?php echo e($user->id); ?>">
                                ...
                                <td>
                                    <input type="checkbox" class="toggle-btn" data-toggle="toggle" data-size="mini"
                                        ...
                                        data-identifier="<?php echo e($user->user_type === 'client' ? $user->id : $user->employee_id); ?>"
                                        <?php echo e($user->status ? 'checked' : ''); ?>>


                                    <a href="<?php echo e(url('/edit-user/' . $user->id)); ?>" class="edit-user">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/relaxed-tereshkova.74-208-156-247.plesk.page/modest-gagarin.74-208-156-247.plesk.page/resources/views/admin/userList.blade.php ENDPATH**/ ?>