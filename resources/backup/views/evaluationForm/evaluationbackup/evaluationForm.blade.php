                    ...
                    <div class="row form-div">
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <input type="text" name="designation" id="designation" value="{{ $designation ?? '' }}"
                                placeholder="Enter designation" class="form-control" readonly disabled>
                        </div>
                        <div class="col-12 col-sm-6">
        ...
        <div class="content-block">
            ...
            <div class="content">
                <div class="form-section">
                    <label for="accuracy_neatness" class="second-label">1. Accuracy, neatness and timeliness of work:
                    </label>
                    {{-- <button type="button" class="info-button" title="Rate Yourself. 0 = Poor, 5 = Excellent.">i</button> --}}
                    ...
                    <select class="form-select" aria-label="multiple select example" name="accuracy_neatness" id="qw1"
                    ...
                    <label for="synchronization" class="second-label">3. Synchronization with organizations/functional
                        goals:
                ...
                <div class="form-section">
                    ...
                    <div>
                        ...
                        <div class="review-block">
                            ...
                            <textarea name="comments_attendance" id="comments_attendance" class="form-control" rows="1"
                                cols="50"></textarea>
                        </div>
                    </div>

                    <div>
                        <label for="initiatives_at_workplace" class="second-label">3. Do you stay busy, look for things
                            to
                            do, take
                        ...
                        <!-- <input type="number" name="initiatives_at_workplace" id="wh3" min="0" max="5" required
                                    oninput="workHabitsTotalRating()" placeholder="Rate Yourself" class="form-control"> -->
                        <select class="form-select" aria-label="multiple select example" name="initiatives_at_workplace"
                            oninput="workHabitsTotalRating()" id="wh3" required>
                            <option selected disabled>Rate</option>
                            <option value="1">1</option>
                            <option value="2">2</option>
                            <option value="3">3</option>
                ...
                <div class="form-section">
                    ...
                    <div>
                        ...
                        <!-- <input type="number" name="problem_solving_ability" id="jk3" min="0" max="5" required
                                    oninput="jobKnowledgeTotalRating()" placeholder="Rate Yourself" class="form-control"> -->
                        <select class="form-select" aria-label="multiple select example" name="problem_solving_ability"
                            oninput="jobKnowledgeTotalRating()" id="jk3" required>
                            <option selected disabled>Rate</option>
                            <option value="1">1</option>
                            <option value="2">2</option>
                            <option value="3">3</option>
            ...
            <div class="content">
                ...
                <div class="form-section">
                    <div>
                        ...
                        {{-- <button type="button" class="info-button"
                                title="Rate Yourself. 0 = Poor, 15 = Excellent.">i</button> --}}
                        ...
                        <div class="review-block">
                            ...
                            <textarea name="comments_challenges" id="comments_challenges" class="form-control" rows="1"
                                cols="50"></textarea>
                        </div>
                    </div>
                ...
                <div>
                    <div class="d-flex align-items-center">
                        <label for="progress_unsatisfactory_yes" class="second-label">1.
                            The employee's performance and learning are unsatisfactory and are failing to improve at a
                            satisfactory rate.
                        </label>
                ...
                <div>
                    <div class="d-flex align-items-center">
                        <label for="progress_acceptable_yes" class="second-label">2.
                            Employee performance and learning are acceptable and are improving at a satisfactory rate.
                        </label>

                        <div class="radio-button radio-block d-flex align-items-center">
                            <div class="radio-block__item">
                                <input type="radio" id="progress_acceptable_yes" name="progress_acceptable" value="Yes">
                                <label for="progress_acceptable_yes">Yes</label>
                            </div>
                            <div class="radio-block__item">
                                <input type="radio" id="progress_acceptable_no" name="progress_acceptable" value="No"
                                    checked>
                    ...
                    <label for="comments_acceptable" class="third-label third-label--new">Justify Your Review:</label>
                ...
                <div>
                    <div class="d-flex align-items-center">
                        ...
                        <div class="radio-button radio-block d-flex align-items-center">
                            ...
                            <div class="radio-block__item">
                                <input type="radio" id="progress_outstanding_no" name="progress_outstanding" value="No"
                                    checked>
                    ...
                    <label for="comments_outstanding" class="third-label third-label--new">Justify Your Review:</label>
...
//Calculate total scoring of evaluation 
...
function calculateAverageRating() {
    ...
    document.getElementById("total-score").innerText = average.toFixed(2);

    document.getElementById("total_scoring_system").value = average.toFixed(2);
}

function waitForValuesAndCalculate() {
    const fields = [
        "leadership_rating",
        "ir_total_rating",
        "jk_total_rating",
    ...
    if (allFilled) {
        ...
        setTimeout(waitForValuesAndCalculate, 100); // check again in 100ms
    }
}

window.addEventListener("load", waitForValuesAndCalculate);
</script>