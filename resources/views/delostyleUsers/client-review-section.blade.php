                    ...
                    <div class="accordion">
                        ...
                        <div class="content-block">
                            ...
                            <div class="content">
                                ...
                                <div>
                                    <label for="concerns_addressed" class="second-label">4. Were your questions and
                                        concerns
                                        addressed
                                        promptly?:</label>
                                    <select class="form-select" aria-label="multiple select example" id="cli1"
                        ...
                        <div class="content-block">
                            ...
                            <label for="section4" class="main-label" class="second-label">D. Code Quality and
                                Performance</label>
                            <div class="content">
                                <label for="quality_code" class="second-label">1. How would you rate the quality of the
                                    code
                                    delivered?:</label>
                                <select class="form-select" aria-label="multiple select example" id="cli1"
                        ...
                        <div class="content-block">
                            ...
                            <div class="content">
                                ...
                                <div>
                                    <label for="effective_workarounds" class="second-label">2. Did the developer(s)
                                        propose
                        ...
                        <div class="form-section form-section--altered total-block">
                            ...
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item" name="ClientTotalReview" id="clientTotalReview" readonly>
                                </li>
    ...
    <script>
        $(function() {
            ...
            $(document).on('click', '.selectable-row', function() {
                ...
                var reviewedYears = $(this).data('client-reviewed-years') || [];
                $('#emp_id_input').val(empId);
                $('#emp_id_input').data('client-reviewed-years', reviewedYears);
