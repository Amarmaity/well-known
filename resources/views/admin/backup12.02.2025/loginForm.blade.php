...
<script>
    $(document).ready(function () {
        $("#send-otp-btn").click(function () {
            ...
            var csrfToken = $('meta[name="csrf-token"]').attr('content');  // CSRF token only once
            ...
            if (email && userType && password) {
                    ...
                    success: function (response) {
                        if (response.status === 'error' && response.message === 'You are under probation period.') {
                            Swal.fire({
                                ...
                                text: response.message || 'You are under probation period.'
                            });
                            return;
                        }
                ...
                alert("Please enter email and user ID before requesting OTP.");
            }
        });
    });
