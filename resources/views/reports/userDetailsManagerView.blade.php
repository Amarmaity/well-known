                ...
                <tbody>
                    @foreach($reviews as $review)
                        <tr>
                            ...
                            <td>({{ $review->rate_employee_quality }}/5)</td>
                        ...
                        <tr>
                            ...
                            <td>({{ $review->organizational_goals }} /5)</td>
                        ...
                        <tr>
                            ...
                            <td>({{ $review->collaborate_colleagues }} /5)</td>
                        ...
                        <tr>
                            ...
                            <td>({{ $review->leadership_responsibilities }}/5)</td>
                        ...
                        <tr>
                            ...
                            <td>({{ $review->informed_progress }} /5)</td>
